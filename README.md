...
<body>
    ...
    <p>Klik tombol di bawah untuk pesan spesial.</p>
    <button onclick="showMessage()">Buka Pesan</button>
    <p id="message">Aku sayang kamu lebih dari kata-kata bisa ungkapkan. Semoga tahun ini penuh cinta dan kebahagiaan! ❤️</p>
